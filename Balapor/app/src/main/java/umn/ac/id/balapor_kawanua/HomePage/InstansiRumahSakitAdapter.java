...
public class InstansiRumahSakitAdapter extends RecyclerView.Adapter<InstansiRumahSakitAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<Instansi> mInstansi;

    public InstansiRumahSakitAdapter(Context mContext, ArrayList<Instansi> mInstansi) {
    ...
    @NonNull
    @Override
    public InstansiRumahSakitAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myView = LayoutInflater.from(mContext).inflate(R.layout.all_instansi_item_homepage, parent, false);
        return new InstansiRumahSakitAdapter.MyViewHolder(myView);
    }

    @Override
    public void onBindViewHolder(@NonNull InstansiRumahSakitAdapter.MyViewHolder holder, int position) {
