...
public class InstansiDinasPemerintahanAdapter extends RecyclerView.Adapter<InstansiDinasPemerintahanAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<Instansi> mInstansi;

    public InstansiDinasPemerintahanAdapter(Context mContext, ArrayList<Instansi> mInstansi) {
    ...
    @NonNull
    @Override
    public InstansiDinasPemerintahanAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myView = LayoutInflater.from(mContext).inflate(R.layout.all_instansi_item_homepage, parent, false);
        return new InstansiDinasPemerintahanAdapter.MyViewHolder(myView);
    }

    @Override
    public void onBindViewHolder(@NonNull InstansiDinasPemerintahanAdapter.MyViewHolder holder, int position) {
